#ifndef HIDL_GENERATED_ANDROID_HARDWARE_GRAPHICS_ALLOCATOR_V4_0_IALLOCATOR_H
#define HIDL_GENERATED_ANDROID_HARDWARE_GRAPHICS_ALLOCATOR_V4_0_IALLOCATOR_H
...
struct IAllocator : public ::android::hidl::base::V1_0::IBase {
    ...
    /**
     * Fully qualified interface name: "android.hardware.graphics.allocator@4.0::IAllocator"
     */
     ...
     */
    using allocate_cb = std::function<void(::android::hardware::graphics::mapper::V4_0::Error error, uint32_t stride, const ::android::hardware::hidl_vec<::android::hardware::hidl_handle>& buffers)>;
    /**
     ...
     */
    virtual ::android::hardware::Return<void> allocate(const ::android::hardware::hidl_vec<uint8_t>& descriptor, uint32_t count, allocate_cb _hidl_cb) = 0;
     ...
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::graphics::allocator::V4_0::IAllocator>> castFrom(const ::android::sp<::android::hardware::graphics::allocator::V4_0::IAllocator>& parent, bool emitError = false);
    /**
     * This performs a checked cast based on what the underlying implementation actually is.
     */
    static ::android::hardware::Return<::android::sp<::android::hardware::graphics::allocator::V4_0::IAllocator>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
static inline std::string toString(const ::android::sp<::android::hardware::graphics::allocator::V4_0::IAllocator>& o);
...
static inline std::string toString(const ::android::sp<::android::hardware::graphics::allocator::V4_0::IAllocator>& o) {
    ...
    os += ::android::hardware::graphics::allocator::V4_0::IAllocator::descriptor;
    os += "]";
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_GRAPHICS_ALLOCATOR_V4_0_IALLOCATOR_H
