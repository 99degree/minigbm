#define LOG_TAG "android.hardware.graphics.allocator@4.0::Allocator"
...
#include <android/hardware/graphics/allocator/4.0/BpHwAllocator.h>
#include <android/hardware/graphics/allocator/4.0/BnHwAllocator.h>
#include <android/hardware/graphics/allocator/4.0/BsAllocator.h>
...
const char* IAllocator::descriptor("android.hardware.graphics.allocator@4.0::IAllocator");
...
// no default implementation for: ::android::hardware::Return<void> IAllocator::allocate(const ::android::hardware::hidl_vec<uint8_t>& descriptor, uint32_t count, allocate_cb _hidl_cb)

// Methods from ::android::hidl::base::V1_0::IBase follow.
::android::hardware::Return<void> IAllocator::interfaceChain(interfaceChain_cb _hidl_cb){
    _hidl_cb({
        ::android::hardware::graphics::allocator::V4_0::IAllocator::descriptor,
...
::android::hardware::Return<void> IAllocator::interfaceDescriptor(interfaceDescriptor_cb _hidl_cb){
    _hidl_cb(::android::hardware::graphics::allocator::V4_0::IAllocator::descriptor);
    return ::android::hardware::Void();
}

::android::hardware::Return<void> IAllocator::getHashChain(getHashChain_cb _hidl_cb){
    _hidl_cb({
        (uint8_t[32]){162,220,241,136,176,33,2,211,207,128,202,10,40,13,206,5,212,90,141,248,9,117,27,60,82,52,116,38,237,88,235,190} /* a2dcf188b02102d3cf80ca0a280dce05d45a8df809751b3c52347426ed58ebbe */,
...
::android::hardware::Return<::android::sp<::android::hardware::graphics::allocator::V4_0::IAllocator>> IAllocator::castFrom(const ::android::sp<::android::hardware::graphics::allocator::V4_0::IAllocator>& parent, bool /* emitError */) {
    return parent;
}

::android::hardware::Return<::android::sp<::android::hardware::graphics::allocator::V4_0::IAllocator>> IAllocator::castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError) {
    return ::android::hardware::details::castInterface<IAllocator, ::android::hidl::base::V1_0::IBase, BpHwAllocator>(
            parent, "android.hardware.graphics.allocator@4.0::IAllocator", emitError);
}

BpHwAllocator::BpHwAllocator(const ::android::sp<::android::hardware::IBinder> &_hidl_impl)
        : BpInterface<IAllocator>(_hidl_impl),
          ::android::hardware::details::HidlInstrumentor("android.hardware.graphics.allocator@4.0", "IAllocator") {
}

// Methods from ::android::hardware::graphics::allocator::V4_0::IAllocator follow.
::android::hardware::Return<void> BpHwAllocator::_hidl_allocate(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_vec<uint8_t>& descriptor, uint32_t count, allocate_cb _hidl_cb) {
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_ENTRY, "android.hardware.graphics.allocator", "4.0", "IAllocator", "allocate", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
    ...
    ::android::hardware::graphics::mapper::V4_0::Error _hidl_out_error;
    ...
    _hidl_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(1 /* allocate */, _hidl_data, &_hidl_reply);
    if (_hidl_err != ::android::OK) { goto _hidl_error; }
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::CLIENT_API_EXIT, "android.hardware.graphics.allocator", "4.0", "IAllocator", "allocate", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
// Methods from ::android::hardware::graphics::allocator::V4_0::IAllocator follow.
::android::hardware::Return<void> BpHwAllocator::allocate(const ::android::hardware::hidl_vec<uint8_t>& descriptor, uint32_t count, allocate_cb _hidl_cb){
    ::android::hardware::Return<void>  _hidl_out = ::android::hardware::graphics::allocator::V4_0::BpHwAllocator::_hidl_allocate(this, this, descriptor, count, _hidl_cb);
...
BnHwAllocator::BnHwAllocator(const ::android::sp<IAllocator> &_hidl_impl)
        : ::android::hidl::base::V1_0::BnHwBase(_hidl_impl, "android.hardware.graphics.allocator@4.0", "IAllocator") { 
...
::android::status_t BnHwAllocator::_hidl_allocate(
    ...
    _hidl_err = ::android::hardware::readEmbeddedFromParcel(
            const_cast<::android::hardware::hidl_vec<uint8_t> &>(*descriptor),
            _hidl_data,
            _hidl_descriptor_parent,
            0 /* parentOffset */, &_hidl_descriptor_child);
    ...
    if (UNLIKELY(mEnableInstrumentation)) {
        ...
        _hidl_args.push_back((void *)&count);
        for (const auto &callback: mInstrumentationCallbacks) {
            callback(InstrumentationEvent::SERVER_API_ENTRY, "android.hardware.graphics.allocator", "4.0", "IAllocator", "allocate", &_hidl_args);
        }
    }
    #endif // __ANDROID_DEBUGGABLE__
...
::android::status_t BnHwAllocator::onTransact(
    ...
    switch (_hidl_code) {
        case 1 /* allocate */:
        {
            ...
            _hidl_err = ::android::hardware::graphics::allocator::V4_0::BnHwAllocator::_hidl_allocate(this, _hidl_data, _hidl_reply, _hidl_cb);
            break;
        }
...
BsAllocator::BsAllocator(const ::android::sp<::android::hardware::graphics::allocator::V4_0::IAllocator> impl) : ::android::hardware::details::HidlInstrumentor("android.hardware.graphics.allocator@4.0", "IAllocator"), mImpl(impl) {
...
bool IAllocator::registerForNotifications(
    ...
    ::android::hardware::Return<bool> success =
            sm->registerForNotifications("android.hardware.graphics.allocator@4.0::IAllocator",
